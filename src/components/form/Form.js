        ...
        <Form onSubmit={formik.handleSubmit} className="shadow-lg p-3 mb-5 bg-light rounded">
          <div className="row">
            <div className="col-md-6 mb-2">
              <Label for="exampleEmail">Buyer Name</Label>
                <Input type="name" name="name" id="name" placeholder="Please Enter your name" onChange={formik.handleChange} value={formik.values.name}/>
            </div>
            <div className="col-md-6 mb-2">
              <div className="row">
              <div className="col">
          ...
          <div className="row">
            ...
            <Label for="exampleSelect">Buyer Address</Label>
              <Input type="textarea" name="address" id="address"onChange={formik.handleChange} value={formik.values.address}/>
            </div>
          ...
          <div className="row">
            <div className="col-md-6 mb-2">
              ...
              <Input type="number" name="phone" id="phone" onChange={formik.handleChange} value={formik.values.phone}/>
            </div>
          </div>
          <div className="row">
          <div className="col-md-6 mb-2">
            <Label for="examplePassword">Zipcode</Label>
              <Input type="number" name="posCode" id="posCode" placeholder="Zipcodes" onChange={formik.handleChange} value={formik.values.posCode}/>
          </div>
          </div>
          <div className="row">
            <div className="col-md-6 mb-2">
              <Label for="exampleText">Quantity</Label>
              <Input type="number" name="quantity" id="quantity" onChange={formik.handleChange} value={formik.values.quantity} />
            </div>
          </div>
